; Mock Exam 2 Tasks
; 1. When pushing PB1, show the letter ‘U’ on the left-hand 7-segment display.
; 2. Simultaneously, treat the right-most 3 switches as a 3-bit unsigned number. Extend this number to be an 8-bit unsigned number. Extend this number to be an 8-bit unsigned number, and show the result on the LEDs LD1-8.
; 3. Simultaneously, treat the left-most 4 switches as a 4-bit twos complement number
; 4. Store this number in a memory location in Bank 1.
; 5. If that number is greater than 5, then show the number ‘6’ on the right-most-hand 7-segment display, otherwise the display should be blank.
...
Conduction_not_filled    ; CODE MOVES HERE WHEN THE PB1 IS NOT PUSHED
    ...
    MOVWF 0X01, 1
    IORWF 0X02, F         ; PUTTING THE VALUE FROM SWTICHES INTO ASSIGNED MEMORY
